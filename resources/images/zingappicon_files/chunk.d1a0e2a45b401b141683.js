...
t.exports={canvasAvailable:r(585),continuousScrollEventsAvailable:r(586),cookiesAvailable:r(587),cssLinearGradientAvailable:r(588),cssPropertyAvailable:r(592),cssViewportUnitsAvailable:r(593),elementAttributeAvailable:r(594),eventTypeAvailable:r(595),isDesktop:r(13),isHandheld:r(189),isRetina:r(188),isTablet:r(190),localStorageAvailable:r(596),mediaElementsAvailable:r(597),mediaQueriesAvailable:r(598),prefersReducedMotion:r(602),sessionStorageAvailable:r(603),svgAvailable:r(604),threeDTransformsAvailable:r(605),touchAvailable:r(86),webGLAvailable:r(187)}},580:function(t,e,r){"use strict"
var n=r(583),i=r(591),o=r(185),a=r(581),s={},c=/(\([^\)]+\))/gi,u=/([^ ,;\(]+(\([^\)]+\))?)/gi
...
var n=r(581),i=r(584),o=r(589),a=r(590),s=r(185),c=function(t,e){var r=o(t),i=!1!==e&&o(e)
